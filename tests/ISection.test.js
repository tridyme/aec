...
const { ISection } = require('../calculations/SectionGeometry');
const cases = require('./mocks/i_sections.json');

describe('I Section Data tests', () => {
  cases.map(section => {
    describe('Section Properties', ()=> {
      const sectionCharac = new ISection(section);
      describe('yg', ()=> {
