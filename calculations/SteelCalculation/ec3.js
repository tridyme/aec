const ec3 = {
  CL: (geometry, steel, loads, sectiontype) => {
    ...
    const b = geometry.b.value;
    const c = geometry.c.value;
    switch (sectiontype) {
      case 'iSectionSteel': {
        const h = geometry.h.value;
        const Ned = loads.Ned.value;
        const gammaM0 = steel.gammaM0.value;
        const fyk = steel.fyk.value;
  ...
  NplRd: (geometry, steel, loads, sectiondata, sectiontype) => {
    ...
    const fyk = steel.fyk.value;
    if (Ned > 0) {
      const gammaM1 = steel.gammaM1.value;
  ...
  khix: (geometry, steel, loads, sectiondata, sectiontype) => {
    const A = sectiondata.A(geometry, sectiontype);
    const fyk = steel.fyk.value;
    const Es = steel.Es.value;
    const L = geometry.L.value;
  ...
  khiLT: (geometry, steel, sectiondata, sectiontype) => {
    ...
    const c = geometry.c.value;
    const L = geometry.L.value;
    const RorW = geometry.RolledOrWelded.value;
    const fyk = steel.fyk.value;
    const Es = steel.Es.value;
    const G = steel.G.value;
    const Iy = sectiondata.Iy(geometry, sectiontype);
  ...
  kxx: (geometry, steel, loads, sectiondata, sectiontype) => {
    const MDx = loads.MomentDiagramX.value;
    const Es = steel.Es.value;
    const L = geometry.L.value;
    const Ix = sectiondata.Ix(geometry, sectiontype);
    const Ned = loads.Ned.value;
  ...
  kxy: (geometry, steel, loads, sectiondata, sectiontype) => {
    const MDy = loads.MomentDiagramY.value;
    const Es = steel.Es.value;
    const L = geometry.L.value;
    const Iy = sectiondata.Iy(geometry, sectiontype);
    const Ix = sectiondata.Ix(geometry, sectiontype);
    ...
    if (MDy === 2) {
      const Myed = loads.Myed.value;
      const deltay = loads.deltay.value;
